...
//             { "Create and Fill the Claim Form,how to cretae and fill the claim form", "Image_2.png" },
//            { "Post-Submission and Follow-Up", "Image_2.png,Image_4.png" },
//            { "Billing and Insurance Information", "Image_5.png" },
//            { "Certification and Declaration", "Image_2.png,Image_4.png" },
...
//            //string normalizedQuery = query.Question.ToLower();
//            string normalizedQuery = Regex.Replace(query.Question, @"[^a-zA-Z\s]", "").ToLower();

//            string documentText = ExtractTextFromDocx(_documentPath);
//            var questions = GetGeneratedQuestions(documentText);

//            // used get the answer and cnt based on doc text
...
//            {
//                //find fuzzy match results if no answer is found above
...
//                        })
//                        .Where(img => !string.IsNullOrEmpty(img))  // Filter out null/empty images
//                        .ToList();
...
namespace ChatbotAPI.Controllers
{
    ...
    public class ChatbotVectorController : ControllerBase
    {
        ...
        private static Dictionary<string, string> _fixedTextToImage = new Dictionary<string, string>
        {
            { "claims create,create claims,claims,what are does claims do", "Image_1.png,Image_2.png" },
            { "manual check,check manual", "Image_6.png" },
            { "Create and Fill the Claim Form,how to create and fill the claim form", "Image_2.png" },
            { "Post Submission and Follow Up", "Image_2.png,Image_4.png" },
            {"Medical Service Information,Login Credentials" ,"Image_4.png"},
            { "Billing and Insurance Information", "Image_5.png" },
            { "Certification and Declaration", "Image_2.png,Image_4.png" },
            {"Required Documents,Documents required","Image_1.png" },
        };
