...
//            if (matchedQuestion != null)
//            {
//                var relatedImages = FindRelatedImages(query.Question);
//                return Ok(new
//                {
//                    answer = matchedQuestion.Text,
//                    context = matchedQuestion.Context,
...
//                context = result.Context,
//                relatedQuestions = result.RelatedQuestions,
//                relatedImages = FindRelatedImages(query.Question)
//            });
//        }
...
//        private List<object> FindRelatedImages(string query)
//        {
//            var imageData = LoadDocumentImages(); // Load image data from your DocumentImagesController logic

//            var relatedImages = new List<object>();

//            foreach (var image in imageData)
//            {
//                int similarity = FuzzySharp.Fuzz.PartialRatio(image.NearbyText, query);

//                if (similarity > 60) // Threshold for similarity
//                {
//                    relatedImages.Add(new
//                    {
...
//        private List<ImageWithText> LoadDocumentImages()
//        {
//            var documentImages = new List<ImageWithText>();
//            string outputDirectory = "C:\\Images";
...
//                {
//                    string nearbyText = GetNearbyTextForImage(imagePath);
//                    documentImages.Add(new ImageWithText
//                    {
//                        ImagePath = imagePath,
...
//        private string GetNearbyTextForImage(string imagePath)
//        {
//            return "Sample nearby text for the image"; // Replace with actual logic
//        }
